# ##
# Convert csv file content to xml file content
# the first row of the csv file to contain column headings that are xml compliant
# for csv to xml the column headings will be used as names of xml elements in the xml output
...
# ##
# shell, csv to xml
java -cp C:\path\to\your\saxon\SaxonHE12-5J\saxon-he-12.5.jar net.sf.saxon.Transform -t -s:dummy.xml -xsl:weather_csv2xml.xsl -o:c:weather_saxon.xml
...
#
# open the xsl file 'weather_csv2xml.xsl'
